...
import com.example.kiit.health.medicine.reminder.AlarmScheduler;
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(com.example.kiit.health.medicine.AddReminderActivity.this);
                    return true;
                }
