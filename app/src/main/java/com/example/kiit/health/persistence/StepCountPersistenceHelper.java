...
public class StepCountPersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_STEPS_SAVED = "com.example.kiit.health.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "com.example.kiit.health.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "com.example.kiit.health.STEPS_INSERTED";
