...
public class MovementSpeedService extends IntentService implements LocationListener, SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     */
    public static final String BROADCAST_ACTION_SPEED_CHANGED = "com.example.kiit.health.SPEED_CHANGED";
    /**
     * Extra key for current speed
     */
    public static final String EXTENDED_DATA_CURRENT_SPEED = "com.example.kiit.health.CURRENT_SPEED";
